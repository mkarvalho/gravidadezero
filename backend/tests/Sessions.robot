...
*** Variables ***
&{inv_pass}         email=kate@email.com    password=abc123
&{inv_email}        email=kate.email.com    password=pwd123
&{email_404}        email=kate@404.com    password=pwd123
&{empty_email}      email=${EMPTY}    password=pwd123
&{wo_email}         password=pwd123
&{empty_pass}       email=kate@email.com    password=${EMPTY}
&{wo_pass}          email=kate@email.com
